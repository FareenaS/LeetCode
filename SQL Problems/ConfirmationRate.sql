...
ELSE ROUND((C.confirmed_count*1.0)/(T.total_count*1.0),2)
END AS confirmation_rate
FROM Signups S
LEFT JOIN Confirm_count C ON C.user_id=S.user_id
LEFT JOIN Total_user_count T ON C.user_id=T.user_id
